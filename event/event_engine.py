...
class SymbolInfo:
    ...
    def __int__(self, currency, symbol, symbol_pair, symbol_pair_ccxt):
        self.symbol = symbol
        self.currency = currency
        self.symbol_pair = symbol_pair
        self.symbol_pair_ccxt = symbol_pair_ccxt


class Event:
    """事件对象"""

    def __init__(self, exchange_name, symbol_info : SymbolInfo, event_type, data=None, data_1h=None):
